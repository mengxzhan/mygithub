...
// fl: set stream mode to reduce crc error 
...
#define  EHCI_CMD_ASYNCHRNOUS_PARK_ENABLE          (0x00000800)
#define  EHCI_CMD_ASYNCHRONOUS_COUNT               (0x00000300)
...
// fl: 16 for ttc  #define  VUSB20_MAX_ENDPTS_SUPPORTED               (0x1F)
#define  VUSB20_MAX_ENDPTS_SUPPORTED               (0x10) 
...
#define  EHCI_QTD_ERROR_BITS_MASK                  (0x00000036)
#define  EHCI_QTD_TRANSFER_ERROR_BITS_MASK         (0x00000008)
