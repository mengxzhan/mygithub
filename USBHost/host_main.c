...
{ /* Body */
   ...
   DEBUGMSG(USB_DBG_LEVEL, ("_usb_host_init\n"));
#endif

   /* Initialize the USB interface. */   
   usb_host_state_struct_ptr = (USB_HOST_STATE_STRUCT_PTR)
       USB_Uncached_memalloc(sizeof(USB_HOST_STATE_STRUCT));
   
   if (usb_host_state_struct_ptr == NULL) {
      #ifdef _HOST_DEBUG_
         DEBUG_LOG_TRACE("_usb_host_init host state malloc failure");
         DEBUGMSG(USB_DBG_LEVEL, ("_usb_host_init host state malloc failure\n"));
      #endif
      return USBERR_ALLOC;
   } /* Endif */
   ...
   */
   ...
   usb_host_state_struct_ptr->PIPE_DESCRIPTOR_BASE_PTR = 
      (PIPE_DESCRIPTOR_STRUCT_PTR)USB_Uncached_memalloc\
...
{ /* Body */
   ...
   usb_host_ptr = (USB_HOST_STATE_STRUCT_PTR)handle;
      ...
      DEBUGMSG(USB_DBG_LEVEL, ("_usb_host_register_service\n"));
   #endif
   ...
   service_ptr = (USB_SERVICE_STRUCT_PTR)USB_Uncached_memalloc\
...
{ /* Body */
   ...
   usb_host_ptr = (USB_HOST_STATE_STRUCT_PTR)handle;
      ...
      DEBUGMSG(USB_DBG_LEVEL, ("_usb_host_call_service\n"));
   #endif
      //DEBUGMSG(1,("b"));
...
{ /* Body */
   ...
   /* Needs mutual exclusion */
      ...
      DEBUGMSG(USB_DBG_LEVEL, ("_usb_host_check_service\n"));
   #endif
      //DEBUGMSG(1,("c"));
...
{ /* Body */
   ...
   USB_HOST_STATE_STRUCT_PTR  usb_host_ptr;
   PIPE_DESCRIPTOR_STRUCT_PTR pipe_base_ptr;
   uint_32 i;
   
   usb_host_ptr = (USB_HOST_STATE_STRUCT_PTR)handle;
   #ifdef _HOST_DEBUG_
      DEBUG_LOG_TRACE("_usb_host_open_pipe");
      DEBUGMSG(USB_DBG_LEVEL, ("_usb_host_open_pipe\n"));
   #endif
   DEBUGMSG(USB_DBG_LEVEL, ("_usb_host_open_pipe\n"));
   USB_lock();
   pipe_base_ptr = usb_host_ptr->PIPE_DESCRIPTOR_BASE_PTR;
   for (i=0; i < USB_MAX_PIPES; i++) {
      /* Check if a pipe is not open */
//      if (!(usb_host_ptr->PIPE_DESCRIPTOR_BASE_PTR[i].OPEN )) {
	  if(!pipe_base_ptr->OPEN) {
         break;
      } /* Endif */
	  DEBUGMSG(USB_DBG_LEVEL, ("we are here: %x \r\n", pipe_base_ptr));
	  pipe_base_ptr++;
   } /* Endfor */
   ...
   if (i != USB_MAX_PIPES) {
      pipe_descr_ptr = pipe_base_ptr;
//         &usb_host_ptr->PIPE_DESCRIPTOR_BASE_PTR[i];
      DEBUGMSG(USB_DBG_LEVEL, ("pipe_descr_ptr: %x \r\n", pipe_base_ptr));
...
//      *pipe_descr_as_params = *pipe_init_params_ptr;
      pipe_descr_ptr->DEV_INSTANCE = pipe_init_params_ptr->DEV_INSTANCE;
      pipe_descr_ptr->INTERVAL = pipe_init_params_ptr->INTERVAL;
      pipe_descr_ptr->MAX_PACKET_SIZE = pipe_init_params_ptr->MAX_PACKET_SIZE;
      pipe_descr_ptr->NAK_COUNT = pipe_init_params_ptr->NAK_COUNT;
      pipe_descr_ptr->FIRST_FRAME = pipe_init_params_ptr->FIRST_FRAME;
      pipe_descr_ptr->FIRST_UFRAME = pipe_init_params_ptr->FIRST_UFRAME;
      pipe_descr_ptr->FLAGS = pipe_init_params_ptr->FLAGS;
      pipe_descr_ptr->DEVICE_ADDRESS = pipe_init_params_ptr->DEVICE_ADDRESS;
      pipe_descr_ptr->ENDPOINT_NUMBER = pipe_init_params_ptr->ENDPOINT_NUMBER;
      pipe_descr_ptr->DIRECTION = pipe_init_params_ptr->DIRECTION;
      pipe_descr_ptr->PIPETYPE = pipe_init_params_ptr->PIPETYPE;
      pipe_descr_ptr->SPEED = pipe_init_params_ptr->SPEED;
      pipe_descr_ptr->TRS_PER_UFRAME = pipe_init_params_ptr->TRS_PER_UFRAME;
//     memcpy(pipe_descr_as_params,pipe_init_params_ptr,sizeof(PIPE_INIT_PARAM_STRUCT));
...
{ /* Body */
   ...
   PIPE_TR_STRUCT_PTR            pipe_tr_ptr, temp_pipe_tr_ptr;
      ...
      DEBUGMSG(USB_DBG_LEVEL, ("_usb_host_new_tr_element\n"));
   #endif
//   DEBUGMSG(USB_DBG_LEVEL, ("_usb_host_new_tr_element\n"));
   pipe_tr_ptr = (PIPE_TR_STRUCT_PTR)USB_Uncached_memalloc(sizeof(PIPE_TR_STRUCT));
   if (pipe_tr_ptr == NULL)
   {
      #ifdef _HOST_DEBUG_
   ...
   USB_memzero((pointer)pipe_tr_ptr, sizeof(PIPE_TR_STRUCT));
...
{ /* Body */
   ...
   PIPE_TR_STRUCT_PTR         pipe_tr_list, temp_pipe_tr_list;
      ...
      DEBUGMSG(USB_DBG_LEVEL, ("_usb_host_get_tr_element\n"));
   #endif
...
{ /* Body */
   ...
   pipe_descr_ptr = (PIPE_DESCRIPTOR_STRUCT_PTR)pipe_handle;
      ...
      DEBUGMSG(USB_DBG_LEVEL, ("_usb_host_set_up_TR\n"));
   #endif
      //DEBUGMSG(1,("_usb_host_set_up_TR"));
...
{ /* Body */
   ...
   uint_32                    return_code;   
      ...
      DEBUGMSG(USB_DBG_LEVEL, ("_usb_host_send_setup\n"));
   #endif
   ...
   if (pipe_descr_ptr->PIPE_ID > USB_MAX_PIPES) {
      #ifdef _HOST_DEBUG_
         DEBUG_LOG_TRACE("_usb_host_send_setup invalid pipe handle");
      #endif
      return USBERR_INVALID_PIPE_HANDLE;
   } /* Endif */
   ...
   */
   if (pipe_descr_ptr->STATUS != USB_STATUS_IDLE) {
      USB_unlock();
      #ifdef _HOST_DEBUG_
         DEBUG_LOG_TRACE("_usb_host_send_setup transfer in progress");
      #endif
   ...
   ***************************************************************/
   ...
   USB_unlock();
      ...
      DEBUGMSG(USB_DBG_LEVEL, ("_usb_host_send_setup SUCCESSFUL\n"));
   #endif
...
{ /* Body */
   ...
   pipe_descr_ptr = (PIPE_DESCRIPTOR_STRUCT_PTR)pipe_handle;
      ...
      DEBUGMSG(USB_DBG_LEVEL, ("_usb_host_get_transfer_status SUCCESSFUL\n"));
   #endif
   ...
   uint_32                    status = USBERR_INVALID_PIPE_HANDLE;
     ...
     DEBUGMSG(USB_DBG_LEVEL, ("_usb_host_get_transfer_status\n"));
#endif
   USB_lock();
