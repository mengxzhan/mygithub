...
volatile boolean test_flag_new = FALSE;
...
Bad_Exit:
   ...
   #endif
   USB_memzero(intf_ptr, sizeof(USB_MASS_CLASS_INTF_STRUCT_PTR));
...
{ /* Body */
   ...
   #endif
//      armprintf(("usb_class_mass_call_back_cbw \r\n"));
   if (user_parm) {
