...
#define  USB_PROTOCOL_HUB_NONE		0
...
#define PIPE_INFO_FIELDS                                             \
   ...
   uint_32     INTERVAL;           /* Interval for polling pipe   */ \
                                   /* for data transfer.          */ \
   uint_32     MAX_PACKET_SIZE;    /* Pipe's maximum packet size  */ \
...
USB_STATUS ch9_get_status_ex(_usb_device_instance_handle, uint_16_ptr, tr_callback);
USB_STATUS usb_enable_period_schedule(_usb_host_handle);
#ifdef __cplusplus
}
#endif                         
