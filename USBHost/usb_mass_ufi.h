...
#define UFI_MODE_SENSE                    (0x1A)// SSS (0x5A)
...
#define usb_mass_ufi_read_capacity(                                       \
   ...
   usb_mass_ufi_generic(cmd_ptr,                                          \
      UFI_READ_CAPACITY,                                                  \
      (cmd_ptr->LUN << 5) | READ_CAPCITY_LUN_HEADER_BITS,                 \
      0,                                                                  \
      0,                                                                  \
      CBW_DIRECTION_IN,                                                   \
      buf_ptr,                                                            \
...
#define usb_mass_ufi_format_unit(                                         \
   ...
   usb_mass_ufi_generic(cmd_ptr,                                          \
      UFI_FORMAT_UNIT,                                                    \
      (cmd_ptr->LUN << 5) | FORMAT_LUN_HEADER_BITS,                       \
...
#define usb_mass_ufi_inquiry(                                             \
   ...
   usb_mass_ufi_generic(cmd_ptr,                                          \
      UFI_INQUIRY,                                                        \
      (cmd_ptr->LUN << 5) | INQUIRY_LUN_HEADER_BITS,                      \
      (buf_len & 0xFF) << 8,                                              \
      0,                                                                  \
      CBW_DIRECTION_IN,                                                   \
      buf_ptr,                                                            \
...
#define usb_mass_ufi_mode_select(                                         \
   ...
   usb_mass_ufi_generic(cmd_ptr,                                          \
      UFI_MODE_SELECT,                                                    \
      (cmd_ptr->LUN << 5) | MODE_SELECT_LUN_HEADER_BITS,                  \
      0,                                                                  \
...
#define usb_mass_ufi_mode_sense(                                          \
   ...
   usb_mass_ufi_generic(cmd_ptr,                                          \
      UFI_MODE_SENSE,                                                     \
      (cmd_ptr->LUN << 5) | MODE_SENSE_LUN_HEADER_BITS,                   \
...
#define usb_mass_ufi_read_10(                                             \
   ...
   usb_mass_ufi_generic(cmd_ptr,                                          \
      UFI_READ10,                                                         \
      (cmd_ptr->LUN << 5) | READ10_LUN_HEADER_BITS,                       \
      bBlock_address,                                                     \
      num_of_sectors << 8,                                                \
      CBW_DIRECTION_IN,                                                   \
      buf_ptr,                                                            \
...
#define usb_mass_ufi_read_12(                                             \
   ...
   usb_mass_ufi_generic(cmd_ptr,                                          \
      UFI_READ12,                                                         \
      (cmd_ptr->LUN << 5) | READ12_LUN_HEADER_BITS,                       \
      bBlock_address,                                                     \
      num_of_sectors,                                                     \
      CBW_DIRECTION_IN,                                                   \
      buf_ptr,                                                            \
...
#define usb_mass_ufi_send_diagnostic(                                     \
   ...
   usb_mass_ufi_generic(cmd_ptr,                                          \
      UFI_SEND_DIAGNOSTIC,                                                \
      ((cmd_ptr->LUN << 5) | SEND_DIAG_LUN_HEADER_BITS) |                 \
         ((bSelf_test & 0xFF) << 2),                                      \
      0,                                                                  \
      0,                                                                  \
      CBW_DIRECTION_OUT,                                                  \
...
#define usb_mass_ufi_verify(                                              \
   ...
   usb_mass_ufi_generic(cmd_ptr,                                          \
      UFI_VERIFY,                                                         \
      (cmd_ptr->LUN << 5) | VERIFY_LUN_HEADER_BITS,                       \
      bBlock_address,                                                     \
      dLength << 8,                                                       \
      CBW_DIRECTION_OUT,                                                  \
      NULL,                                                               \
...
#define usb_mass_ufi_write_10(                                            \
      ...
      /* COMMAND_OBJECT_PTR */      cmd_ptr,                              \
                                                                          \
      /* [IN] Address of the block to be write*/                          \
      /* uint_32 */                 bBlock_address,                       \
                                                                          \
      /* [IN] buffer to send or receive data*/                            \
      /* pointer */                 buf_ptr,                              \
   ...
   usb_mass_ufi_generic(cmd_ptr,                                          \
      UFI_WRITE10,                                                        \
      (cmd_ptr->LUN << 5) | UFI_WRITE_LUN_HEADER_BITS,                    \
      bBlock_address,                                                     \
      num_of_sectors << 8,                                                \
      CBW_DIRECTION_OUT,                                                  \
      buf_ptr,                                                            \
