...
#endif
   {
	   usb_class_hub_init,					// class_init
	   sizeof(USB_HUB_CLASS_INTF_STRUCT),	// intf_struct_size
	   USB_CLASS_HUB,						// intf_class
	   USB_SUBCLASS_HUB_NONE,				// sub_class
	   USB_PROTOCOL_HUB_NONE,				// protocol
	   0xFF, 0x00, 0x00						// class_mask, sub_mask, prot_mask
   },
#ifdef USBCLASS_INC_PRINTER
   {
      usb_printer_init,
